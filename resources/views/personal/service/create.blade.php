    ...
    <div class="card">
        <div class="card-body">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('personal.service.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <a href="{{ route('personal.service.index') }}" class="btn btn-outline-primary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
